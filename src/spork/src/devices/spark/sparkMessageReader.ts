...
export class SparkMessageReader {
    ...
    read_effect_parameter() {
        ...
        this.receivedMessageQueue.push(<FxParamMessage>{
            type: "fx_param_msg",
            dspId: effect,
            value: val,
            index: param,
    ...
    read_effect() {
        ...
        this.receivedMessageQueue.push(<FxChangeMessage>{
            type: "fx_change_msg",
            dspIdOld: effect1,
            dspIdNew: effect2,
        });
    ...
    read_hardware_preset() {
        ...
        this.receivedMessageQueue.push(<PresetChangeMessage>{
            type: "hardware_channel_current",
            presetNumber: preset_num,
        });
    }
    ...
    public static getAckMessage(sub_cmd): string {
        ...
        switch (sub_cmd) {
            case 0x01:
                ...
                break;
            case 0x05:
                ackMsg += "Preset Final Chunk";
                break;
            case 0x06:
                ackMsg += "Changed Amp Model";
                break;
            case 0x15:
                ackMsg += "Turn FX On/Off";
                break;
            case 0x38:
                ackMsg += "Changed Preset Number";
                break;
            case 0x70:
                ackMsg += "License Key";
                break;
