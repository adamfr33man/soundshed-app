                ...
                <div>
                    ...
                    <Form>
                        ...
                        <div className="mt-2">
                            ...
                            {registrationFailed ? (
                                <Alert variant="danger">
                                    Registration failed. Check email address and password are set and you are not using
                                    an email that's already registered.
                                </Alert>
                            ) : (
                                ""
                            )}
                            ...
                            {!isRegMode ? (
                                <button className="float-end btn btn-primary" type="button" onClick={handleSignIn}>
                                    Sign In
                                </button>
                            ) : (
                                <button className="btn btn-info float-end" type="button" onClick={handleRegister}>
                                    New User
                                </button>
                            )}
                        </div>
                    ...
                    <p className="small mt-2">
                        Note: A Soundshed.com account is unrelated to a PG Account and is used to share tones to
                        soundshed.com community.
                    </p>
                </div>
            </Modal.Body>
        </Modal>
