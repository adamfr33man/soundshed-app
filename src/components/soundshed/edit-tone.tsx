...
const EditToneControl = () => {
    const openToneEdit: boolean = ToneEditStore.useState((s) => s.isToneEditorOpen);
                ...
                <Modal.Body>
                    <div>
                        ...
                        <Form onSubmit={handleSubmit}>
                            ...
                            {saveFailed ? <Alert variant="danger">Failed to save update.</Alert> : ""}
                            <button type="button" onClick={handleCancel}>
                                Cancel
                            </button>
                            <button type="button" className="ms-4 btn btn-danger" onClick={handleDelete}>
                                Delete
                            </button>
